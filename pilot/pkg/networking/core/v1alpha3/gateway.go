...
func buildGatewayListenerTLSContext(
	server *networking.Server, proxy *model.Proxy, transportProtocol istionetworking.TransportProtocol, gatewayTCPServerWithTerminatingTLS bool) *tls.DownstreamTlsContext {
